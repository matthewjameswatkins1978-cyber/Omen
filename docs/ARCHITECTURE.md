...
2. **Wire Specification (`omen-schema`)**: Strict JSON Schemas for execution contracts and results, enforcing closed models (`deny_unknown_fields`) and strict semantic versions (`omen.execution/0.2`, `omen.result/0.3`).
